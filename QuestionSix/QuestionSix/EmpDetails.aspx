...
<body>
    ...
    <div class="auto-style1">
        ...
        <br />
        <br />
        <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateRows="False" CellPadding="4" DataKeyNames="empid" DataSourceID="SqlDataSource1" FooterText="by Elijah Ayeeta" ForeColor="#333333" GridLines="None" HeaderText="Detail View Shows Department ID and Eployee Names" Height="50px" Width="400px">
